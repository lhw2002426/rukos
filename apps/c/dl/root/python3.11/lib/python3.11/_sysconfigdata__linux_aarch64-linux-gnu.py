...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/bin',
 'BINLIBDEST': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11',
 'BLDLIBRARY': 'libpython3.11.a',
 'BLDSHARED': 'aarch64-linux-musl-gcc -shared '
              '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/  '
              '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/  '
           '-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/',
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -std=c11 -Wextra '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/',
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11' "
                "'--with-build-python=python3.11' '--build=x86_64' "
                "'--host=aarch64-linux-musl' '--enable-ipv6' "
                "'CONFIG_SITE=./CONFIG_SITE' '--enable-optimizations' "
                "'build_alias=x86_64' 'host_alias=aarch64-linux-musl' "
                "'PKG_CONFIG_PATH=/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/pkgconfig' "
                "'CFLAGS= "
                "-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/' "
                "'LDFLAGS= "
                "-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/'",
 'CONFINCLUDEDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include',
 'CONFINCLUDEPY': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8/lcov-report',
 ...
 'DESTDIRS': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11 '
             '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib '
             '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11 '
             '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11/lib-dynload',
 'DESTLIB': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include '
                   '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include '
                   '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/python3.11 '
                   '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/python3.11',
 'INCLUDEDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include',
 'INCLUDEPY': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include/python3.11',
 ...
 'LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/  '
            '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11',
 'LIBDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/pkgconfig',
 'LIBPL': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11/config-3.11-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'aarch64-linux-musl-gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include',
 'MODULE_BINASCII_LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include',
 'MODULE_ZLIB_LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib '
                        '-lz',
 ...
 'MODULE__LZMA_CFLAGS': '-I/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/include',
 'MODULE__LZMA_LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib '
                         '-llzma',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_CORE_LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/  '
                    '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/ '
                    '-fno-semantic-interposition',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/  '
               '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/',
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'PY_LDFLAGS_NOLTO': '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/  '
                     '-L/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl  -lpthread',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               'python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11',
 'WASM_STDLIB': './media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8',
 'abs_srcdir': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/build/Python-3.11.8',
 'datarootdir': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11/share',
 'exec_prefix': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11',
 'prefix': '/media/robert/data/ruxos-0322/ruxos-czn/build-python/python3.11',
 'srcdir': '.'}
